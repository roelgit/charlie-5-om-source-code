...
We were right in assuming the maximum amount of iterations is has a direct linear correlation to the runtime, as the correlation coefficient is extremely close to 1. This came as no surprise to use.
