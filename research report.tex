...
Force_{final} = c_4 * Force_{results}
\end{equation}
...
\newline
According to Eades, research has shown that the values $c_1=2$, $c_2=c_3=1$ and $c_4=0.1$ give the best results for most input graphs and that almost all graphs stabilize after 100 iterations.
